...
dots.prototype.drawShape = function(target, color, real_color){
    ...
    hit.graphics.beginFill("#000").rect(-40, -40, 80, 80);
    target.hitArea = hit;*/
    target.graphics.beginStroke("");
    target.graphics.beginFill("rgba(255,255,255,0.01)");
    target.graphics.drawRect(-40, -40, 80, 80);
}
