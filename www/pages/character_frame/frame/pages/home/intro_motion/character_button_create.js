...
(lib.character = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({scaleX:1.23,scaleY:1.23,x:-0.5,y:-63.8},10).to({scaleX:0.95,scaleY:0.95,y:-47},4).wait(55).to({regX:0.2,regY:-27.1,scaleX:1.21,scaleY:1.21,x:-0.4,y:-70.3},7).to({scaleX:1,scaleY:1,y:-63.7},5).to({_off:true},124).wait(90));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_28}]}).to({state:[{t:this.shape_28}]},14).to({state:[{t:this.shape_29}]},1).to({state:[{t:this.shape_30}]},1).to({state:[{t:this.shape_31}]},1).to({state:[{t:this.shape_32}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_34}]},1).to({state:[{t:this.shape_35}]},1).to({state:[{t:this.shape_36}]},1).to({state:[{t:this.shape_37}]},1).to({state:[{t:this.shape_38}]},1).to({state:[{t:this.shape_39}]},1).to({state:[{t:this.shape_39}]},16).to({state:[{t:this.shape_40}]},1).to({state:[{t:this.shape_41}]},1).to({state:[{t:this.shape_42}]},1).to({state:[{t:this.shape_43}]},1).to({state:[{t:this.shape_44}]},1).to({state:[{t:this.shape_45}]},1).to({state:[{t:this.shape_46}]},1).to({state:[{t:this.shape_47}]},91).to({state:[{t:this.shape_48}]},3).to({state:[{t:this.shape_49}]},3).to({state:[{t:this.shape_50}]},16).to({state:[{t:this.shape_50}]},8).to({state:[{t:this.instance_7}]},36).to({state:[{t:this.instance_7}]},11).to({state:[{t:this.instance_7}]},32).to({state:[{t:this.instance_7}]},11).to({state:[]},24).wait(12));
	...
	this.shape_59.graphics.f("#FEDEB9").s().p("AgHGiQgPgBgNgEQglgMgagfIgBgDQghgpAAg4IAAosQAAgrAZgiIABgBQAHgKAKgJQAUgSAYgJQAagJAcADQAOABANADQAlAMAaAgIABABIANATQAUAkAAArIAAIrIAAABQAAArgYAhQgIALgKAJQgVAUgZAIQgVAHgWAAIgJAAg");
	this.shape_59.setTransform(17,91.7);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#FEDEB9").s().p("AhdFqQgngnAAg3IAAoXQAAgrAXggQAHgKAJgJQAngnA2AAQA3AAAnAnQAJAJAHAKQAXAgAAArIAAIXQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_60.setTransform(17,89.9);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#F1C27D").s().p("AhdFqQgngnAAg3IAAoXQAAgrAXggQAHgKAJgJQAngnA2AAQA3AAAnAnQAJAJAHAKQAXAgAAArIAAIXQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_61.setTransform(17,89.9);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#C68642").s().p("AhdFqQgngnAAg3IAAoXQAAgrAXggQAHgKAJgJQAngnA2AAQA3AAAnAnQAJAJAHAKQAXAgAAArIAAIXQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_62.setTransform(17,89.9);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#8D5524").s().p("AhdFqQgngnAAg3IAAoXQAAgrAXggQAHgKAJgJQAngnA2AAQA3AAAnAnQAJAJAHAKQAXAgAAArIAAIXQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_63.setTransform(17,89.9);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#475FC4").s().p("AiEEqIAAnOQAAgrAXggQAHgKAJgJQAngnA2AAQA3AAAnAnQAJAJAHAKQAXAgAAArIAAHOg");
	this.shape_64.setTransform(17,79.6);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#8D5524").s().p("AhdBAQgngnAAg2IAAhJIEJAAIAABJQAAA2gnAnQgnAng3AAQg2AAgngng");
	this.shape_65.setTransform(17,119.7);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_51}]}).to({state:[{t:this.shape_52}]},14).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},16).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_52}]},10).to({state:[{t:this.shape_53}]},1).to({state:[{t:this.shape_54}]},1).to({state:[{t:this.shape_55}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_57}]},1).to({state:[{t:this.shape_58}]},1).to({state:[{t:this.shape_59}]},1).to({state:[{t:this.shape_60}]},1).to({state:[{t:this.shape_61}]},73).to({state:[{t:this.shape_62}]},3).to({state:[{t:this.shape_63}]},3).to({state:[{t:this.shape_63}]},16).to({state:[{t:this.shape_65},{t:this.shape_64}]},8).to({state:[{t:this.instance_8}]},36).to({state:[{t:this.instance_8}]},11).to({state:[{t:this.instance_8}]},32).to({state:[{t:this.instance_8}]},11).to({state:[]},24).wait(12));
	...
	this.shape_66.graphics.f("#FEDEB9").s().p("ACoIAQgmgnAAg3IAAtDQAAg3AmgnQAngnA3AAQA4AAAnAnQAnAngBA3IAANDQABA3gnAnQgnAng4AAQg3AAgngngAljIAQgognAAg3IAAtDQAAg3AognQAngnA2AAQA4AAAnAnQAmAnABA3IAANDQgBA3gmAnQgnAng4AAQg2AAgngng");
	this.shape_66.setTransform(0.7,134.9);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#FEDEB9").s().p("AhdIAQgngnAAg3IAAtDQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAANDQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_67.setTransform(-25.5,134.9);
	this.shape_67._off = true;

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#FEDEB9").s().p("AhdHtQgngnAAg3IAAsdQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAMdQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_68.setTransform(-15.5,103);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#FEDEB9").s().p("AhdHbQgngnAAg4IAAr3QAAg4AngnQAngnA2ABQA3gBAnAnQAnAnAAA4IAAL3QAAA4gnAnQgnAmg3ABQg2gBgngmg");
	this.shape_69.setTransform(-15.5,101.1);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#FEDEB9").s().p("AhdHIQgngnAAg3IAArTQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAALTQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_70.setTransform(-15.5,99.2);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#FEDEB9").s().p("AhdG1QgngnAAg3IAAqtQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAKtQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_71.setTransform(-15.5,97.4);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#FEDEB9").s().p("AhdGiQgngnAAg3IAAqHQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAKHQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_72.setTransform(-15.5,95.5);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#FEDEB9").s().p("AhdGQQgngnAAg4IAAphQAAg4AngnQAngnA2ABQA3gBAnAnQAnAnAAA4IAAJhQAAA4gnAnQgnAng3gBQg2ABgngng");
	this.shape_73.setTransform(-15.5,93.6);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#FEDEB9").s().p("AhdF9QgngnAAg3IAAo9QAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAI9QAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_74.setTransform(-15.5,91.7);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#FEDEB9").s().p("AhdFqQgngnAAg3IAAoXQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAIXQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_75.setTransform(-15.5,89.9);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#F1C27D").s().p("AhdFqQgngnAAg3IAAoXQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAIXQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_76.setTransform(-15.5,89.9);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("#C68642").s().p("AhdFqQgngnAAg3IAAoXQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAIXQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_77.setTransform(-15.5,89.9);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#8D5524").s().p("AhdFqQgngnAAg3IAAoXQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAIXQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_78.setTransform(-15.5,89.9);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#475FC4").s().p("AiEEqIAAnOQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAHOg");
	this.shape_79.setTransform(-15.5,79.6);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("#8D5524").s().p("AhdBAQgngnAAg2IAAhJIEJAAIAABJQAAA2gnAnQgnAng3AAQg2AAgngng");
	this.shape_80.setTransform(-15.5,119.7);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_66}]}).to({state:[{t:this.shape_67}]},14).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},16).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},10).to({state:[{t:this.shape_68}]},1).to({state:[{t:this.shape_69}]},1).to({state:[{t:this.shape_70}]},1).to({state:[{t:this.shape_71}]},1).to({state:[{t:this.shape_72}]},1).to({state:[{t:this.shape_73}]},1).to({state:[{t:this.shape_74}]},1).to({state:[{t:this.shape_75}]},1).to({state:[{t:this.shape_76}]},73).to({state:[{t:this.shape_77}]},3).to({state:[{t:this.shape_78}]},3).to({state:[{t:this.shape_78}]},16).to({state:[{t:this.shape_80},{t:this.shape_79}]},8).to({state:[{t:this.instance_9}]},36).to({state:[{t:this.instance_9}]},11).to({state:[{t:this.instance_9}]},32).to({state:[{t:this.instance_9}]},11).to({state:[]},24).wait(12));
	this.timeline.addTween(cjs.Tween.get(this.shape_67).wait(14).to({_off:false},0).wait(1).to({x:-28},0).wait(1).to({x:-30.5},0).wait(1).to({x:-33},0).wait(1).to({x:-35.5},0).wait(1).to({x:-32.7},0).wait(1).to({x:-29.8},0).wait(1).to({x:-27},0).wait(1).to({x:-24.1},0).wait(1).to({x:-21.2},0).wait(1).to({x:-18.4},0).wait(1).to({x:-15.5},0).wait(17).to({y:130.6},0).wait(1).to({y:126.3},0).wait(1).to({y:122},0).wait(1).to({y:117.7},0).wait(1).to({y:113.4},0).wait(1).to({y:109.2},0).wait(1).to({y:104.9},0).wait(10).to({_off:true},1).wait(236));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(205).to({_off:false},0).wait(54).to({_off:true},24).wait(12));

	// arm_left
	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("#FEDEB9").s().p("AhdIAQgngnAAg3IAAtDQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAANDQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_81.setTransform(-55,69.9);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.f("#FEDEB9").s().p("AhdINQgngoAAg3IAAtbQAAg3AngoQAngnA2ABQA3gBAnAnQAnAoAAA3IAANbQAAA3gnAoQgnAng3gBQg2ABgngng");
	this.shape_82.setTransform(-45,71.1);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("#FEDEB9").s().p("AhdIZQgngnAAg3IAAt1QAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAN1QAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_83.setTransform(-45,72.4);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("#FEDEB9").s().p("AhdIlQgngnAAg2IAAuOQAAg3AngoQAngnA2ABQA3gBAnAnQAnAoAAA3IAAOOQAAA2gnAnQgnAog3AAQg2AAgngog");
	this.shape_84.setTransform(-45,73.6);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f("#FEDEB9").s().p("AhdIyQgngnAAg3IAAunQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAOnQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_85.setTransform(-45,74.9);

	this.shape_86 = new cjs.Shape();
	this.shape_86.graphics.f("#FEDEB9").s().p("AhdI/QgngnAAg4IAAu/QAAg3AngoQAngnA2ABQA3gBAnAnQAnAoAAA3IAAO/QAAA4gnAnQgnAng3gBQg2ABgngng");
	this.shape_86.setTransform(-45,76.1);

	this.shape_87 = new cjs.Shape();
	this.shape_87.graphics.f("#FEDEB9").s().p("AhdJLQgngnAAg3IAAvZQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAPZQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_87.setTransform(-45,77.4);

	this.shape_88 = new cjs.Shape();
	this.shape_88.graphics.f("#FEDEB9").s().p("AhdJXQgngmAAg4IAAvxQAAg3AngoQAngnA2ABQA3gBAnAnQAnAoAAA3IAAPxQAAA4gnAmQgnAng3ABQg2gBgngng");
	this.shape_88.setTransform(-45,78.6);

	this.shape_89 = new cjs.Shape();
	this.shape_89.graphics.f("#FEDEB9").s().p("AhdJkQgngnAAg3IAAwLQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAQLQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_89.setTransform(-45,79.9);

	this.shape_90 = new cjs.Shape();
	this.shape_90.graphics.f("#FEDEB9").s().p("AhdHnQgngnAAg3IAAsRQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAMRQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_90.setTransform(-45,67.4);

	this.shape_91 = new cjs.Shape();
	this.shape_91.graphics.f("#FEDEB9").s().p("AhdHOQgngnAAg3IAArfQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAALfQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_91.setTransform(-45,64.9);

	this.shape_92 = new cjs.Shape();
	this.shape_92.graphics.f("#FEDEB9").s().p("AhdG1QgngnAAg3IAAqtQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAKtQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_92.setTransform(-45,62.4);

	this.shape_93 = new cjs.Shape();
	this.shape_93.graphics.f("#FEDEB9").s().p("AhdGcQgngnAAg3IAAp7QAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAJ7QAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_93.setTransform(-45,59.9);

	this.shape_94 = new cjs.Shape();
	this.shape_94.graphics.f("#F1C27D").s().p("AhdGcQgngnAAg3IAAp7QAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAJ7QAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_94.setTransform(-45,59.9);

	this.shape_95 = new cjs.Shape();
	this.shape_95.graphics.f("#C68642").s().p("AhdGcQgngnAAg3IAAp7QAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAJ7QAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_95.setTransform(-45,59.9);

	this.shape_96 = new cjs.Shape();
	this.shape_96.graphics.f("#8D5524").s().p("AhdGcQgngnAAg3IAAp7QAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAJ7QAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_96.setTransform(-45,59.9);

	this.shape_97 = new cjs.Shape();
	this.shape_97.graphics.f("#FFD000").s().p("AiEFMIAAoSQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAISg");
	this.shape_97.setTransform(-45,47.9);

	this.shape_98 = new cjs.Shape();
	this.shape_98.graphics.f("#8D5524").s().p("AhdBQQgngnAAg2IAAhpIEJAAIAABpQAAA2gnAnQgnAng3AAQg2AAgngng");
	this.shape_98.setTransform(-45,93);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_81}]}).to({state:[{t:this.shape_81}]},14).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_82}]},1).to({state:[{t:this.shape_83}]},1).to({state:[{t:this.shape_84}]},1).to({state:[{t:this.shape_85}]},1).to({state:[{t:this.shape_86}]},1).to({state:[{t:this.shape_87}]},1).to({state:[{t:this.shape_88}]},1).to({state:[{t:this.shape_89}]},1).to({state:[{t:this.shape_87}]},1).to({state:[{t:this.shape_85}]},1).to({state:[{t:this.shape_83}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_90}]},1).to({state:[{t:this.shape_91}]},1).to({state:[{t:this.shape_92}]},1).to({state:[{t:this.shape_93}]},1).to({state:[{t:this.shape_93}]},7).to({state:[{t:this.shape_94}]},91).to({state:[{t:this.shape_95}]},3).to({state:[{t:this.shape_96}]},3).to({state:[{t:this.shape_98},{t:this.shape_97}]},16).to({state:[{t:this.shape_98},{t:this.shape_97}]},8).to({state:[{t:this.instance_10}]},36).to({state:[{t:this.instance_10}]},11).to({state:[{t:this.instance_10}]},32).to({state:[{t:this.instance_10}]},11).to({state:[]},24).wait(12));
	this.timeline.addTween(cjs.Tween.get(this.shape_81).wait(15).to({x:-57.5},0).wait(1).to({x:-60},0).wait(1).to({x:-62.5},0).wait(1).to({x:-65},0).wait(1).to({x:-62.2},0).wait(1).to({x:-59.3},0).wait(1).to({x:-56.5},0).wait(1).to({x:-53.6},0).wait(1).to({x:-50.7},0).wait(1).to({x:-47.9},0).wait(1).to({x:-45},0).to({_off:true},1).wait(11).to({_off:false},0).to({_off:true},1).wait(257));
	...
	this.shape_99.graphics.f("#FEDEB9").s().p("AhdIAQgngnAAg3IAAtDQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAANDQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_99.setTransform(56.1,69.9);

	this.shape_100 = new cjs.Shape();
	this.shape_100.graphics.f("#FEDEB9").s().p("AhdINQgngoAAg3IAAtbQAAg3AngoQAngnA2ABQA3gBAnAnQAnAoAAA3IAANbQAAA3gnAoQgnAng3gBQg2ABgngng");
	this.shape_100.setTransform(46.1,71.1);

	this.shape_101 = new cjs.Shape();
	this.shape_101.graphics.f("#FEDEB9").s().p("AhdIZQgngnAAg3IAAt1QAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAN1QAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_101.setTransform(46.1,72.4);

	this.shape_102 = new cjs.Shape();
	this.shape_102.graphics.f("#FEDEB9").s().p("AhdIlQgngnAAg2IAAuOQAAg3AngoQAngnA2ABQA3gBAnAnQAnAoAAA3IAAOOQAAA2gnAnQgnAog3AAQg2AAgngog");
	this.shape_102.setTransform(46.1,73.6);

	this.shape_103 = new cjs.Shape();
	this.shape_103.graphics.f("#FEDEB9").s().p("AhdIyQgngnAAg3IAAunQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAOnQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_103.setTransform(46.1,74.9);

	this.shape_104 = new cjs.Shape();
	this.shape_104.graphics.f("#FEDEB9").s().p("AhdI/QgngnAAg4IAAu/QAAg3AngoQAngnA2ABQA3gBAnAnQAnAoAAA3IAAO/QAAA4gnAnQgnAng3gBQg2ABgngng");
	this.shape_104.setTransform(46.1,76.1);

	this.shape_105 = new cjs.Shape();
	this.shape_105.graphics.f("#FEDEB9").s().p("AhdJLQgngnAAg3IAAvZQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAPZQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_105.setTransform(46.1,77.4);

	this.shape_106 = new cjs.Shape();
	this.shape_106.graphics.f("#FEDEB9").s().p("AhdJXQgngmAAg4IAAvxQAAg3AngoQAngnA2ABQA3gBAnAnQAnAoAAA3IAAPxQAAA4gnAmQgnAng3ABQg2gBgngng");
	this.shape_106.setTransform(46.1,78.6);

	this.shape_107 = new cjs.Shape();
	this.shape_107.graphics.f("#FEDEB9").s().p("AhdJkQgngnAAg3IAAwLQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAQLQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_107.setTransform(46.1,79.9);

	this.shape_108 = new cjs.Shape();
	this.shape_108.graphics.f("#FEDEB9").s().p("AhdHnQgngnAAg3IAAsRQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAMRQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_108.setTransform(46.1,67.4);

	this.shape_109 = new cjs.Shape();
	this.shape_109.graphics.f("#FEDEB9").s().p("AhdHOQgngnAAg3IAArfQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAALfQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_109.setTransform(46.1,64.9);

	this.shape_110 = new cjs.Shape();
	this.shape_110.graphics.f("#FEDEB9").s().p("AhdG1QgngnAAg3IAAqtQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAKtQAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_110.setTransform(46.1,62.4);

	this.shape_111 = new cjs.Shape();
	this.shape_111.graphics.f("#FEDEB9").s().p("AhdGcQgngnAAg3IAAp7QAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAJ7QAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_111.setTransform(46.1,59.9);

	this.shape_112 = new cjs.Shape();
	this.shape_112.graphics.f("#F1C27D").s().p("AhdGcQgngnAAg3IAAp7QAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAJ7QAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_112.setTransform(46.1,59.9);

	this.shape_113 = new cjs.Shape();
	this.shape_113.graphics.f("#C68642").s().p("AhdGcQgngnAAg3IAAp7QAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAJ7QAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_113.setTransform(46.1,59.9);

	this.shape_114 = new cjs.Shape();
	this.shape_114.graphics.f("#8D5524").s().p("AhdGcQgngnAAg3IAAp7QAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAJ7QAAA3gnAnQgnAng3AAQg2AAgngng");
	this.shape_114.setTransform(46.1,59.9);

	this.shape_115 = new cjs.Shape();
	this.shape_115.graphics.f("#FFD000").s().p("AiEFMIAAoSQAAg3AngnQAngnA2AAQA3AAAnAnQAnAnAAA3IAAISg");
	this.shape_115.setTransform(46.1,47.9);

	this.shape_116 = new cjs.Shape();
	this.shape_116.graphics.f("#8D5524").s().p("AhdBQQgngnAAg2IAAhpIEJAAIAABpQAAA2gnAnQgnAng3AAQg2AAgngng");
	this.shape_116.setTransform(46.1,93);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_99}]}).to({state:[{t:this.shape_99}]},14).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_100}]},1).to({state:[{t:this.shape_101}]},1).to({state:[{t:this.shape_102}]},1).to({state:[{t:this.shape_103}]},1).to({state:[{t:this.shape_104}]},1).to({state:[{t:this.shape_105}]},1).to({state:[{t:this.shape_106}]},1).to({state:[{t:this.shape_107}]},1).to({state:[{t:this.shape_105}]},1).to({state:[{t:this.shape_103}]},1).to({state:[{t:this.shape_101}]},1).to({state:[{t:this.shape_99}]},1).to({state:[{t:this.shape_108}]},1).to({state:[{t:this.shape_109}]},1).to({state:[{t:this.shape_110}]},1).to({state:[{t:this.shape_111}]},1).to({state:[{t:this.shape_111}]},7).to({state:[{t:this.shape_112}]},91).to({state:[{t:this.shape_113}]},3).to({state:[{t:this.shape_114}]},3).to({state:[{t:this.shape_116},{t:this.shape_115}]},16).to({state:[{t:this.shape_116},{t:this.shape_115}]},8).to({state:[{t:this.instance_11}]},36).to({state:[{t:this.instance_11}]},11).to({state:[{t:this.instance_11}]},5).to({state:[{t:this.instance_11}]},4).to({state:[{t:this.instance_11}]},4).to({state:[{t:this.instance_11}]},4).to({state:[{t:this.instance_11}]},3).to({state:[{t:this.instance_11}]},4).to({state:[{t:this.instance_11}]},8).to({state:[{t:this.instance_11}]},11).to({state:[]},24).wait(12));
	this.timeline.addTween(cjs.Tween.get(this.shape_99).wait(15).to({x:58.6},0).wait(1).to({x:61.1},0).wait(1).to({x:63.6},0).wait(1).to({x:66.1},0).wait(1).to({x:63.3},0).wait(1).to({x:60.4},0).wait(1).to({x:57.6},0).wait(1).to({x:54.7},0).wait(1).to({x:51.8},0).wait(1).to({x:49},0).wait(1).to({x:46.1},0).to({_off:true},1).wait(11).to({_off:false},0).to({_off:true},1).wait(257));
	...
	this.shape_117.graphics.f("#FEDEB9").s().p("Al3F5QidicAAjdQAAjbCdidQCbicDcABQDdgBCbCcQCdCdAADbQAADdidCcQibCbjdABQjcgBibibg");
	this.shape_117.setTransform(0,-53.2);

	this.shape_118 = new cjs.Shape();
	this.shape_118.graphics.f("#FEDEB9").s().p("AhdIwQh5gUhog+QgogYgkgfQi0iXgFj1IAAAAQgEjvCjisQAlgnApggQAsggAwgXQBrg1B9gEQA8gCA5AJQClAbCCB5IAQAPQAmAmAfArQBeCHAGCpQAFB3gmBsQgmBnhOBSQh0B8ilAgQg+ALhCABIgGAAQg3AAg1gIg");
	this.shape_118.setTransform(-0.1,-57);

	this.shape_119 = new cjs.Shape();
	this.shape_119.graphics.f("#FEDEB9").s().p("AhSJVQiDgRhzg6QgtgWgngeQjMiSgKkOQgJkCCqi9QAmgqAsgkQAvgkAzgaQBzg8CEgIQBBgEA+AIQCxAXCRB+IARAPQArAoAjAtQBqCQANCzQAKB/glB3QgjBzhQBZQh4CGi3AgQhDAMhHABIgIAAQg7AAg5gHg");
	this.shape_119.setTransform(-0.2,-60.7);

	this.shape_120 = new cjs.Shape();
	this.shape_120.graphics.f("#FEDEB9").s().p("AhHJ6QiMgPiAg1QgxgUgrgdQjkiNgPkmIAAAAQgNkWCxjNQAoguAugoQAxgnA3geQB7hECMgMQBEgGBDAHQC/AUCfCDIATAQQAvAqAnAvQB2CYAVC+QAOCGgjCDQgiB/hRBeQh8CSjKAfQhIAMhMACIgYAAQg3AAg2gGg");
	this.shape_120.setTransform(-0.2,-64.5);

	this.shape_121 = new cjs.Shape();
	this.shape_121.graphics.f("#FEDEB9").s().p("Ag8KfQiWgMiLgxQg2gSgwgbQj7iJgUk+IAAgBQgRkoC3jeQAqgyAxgsQA0grA5ghQCEhLCTgQQBJgJBHAHQDMAQCuCIIAUARQA0ArAqAyQCDChAbDIQAUCNgiCOQggCLhTBlQh/CdjdAfQhOAMhQABIgkABQg1AAg1gFg");
	this.shape_121.setTransform(-0.2,-68.3);

	this.shape_122 = new cjs.Shape();
	this.shape_122.graphics.f("#FEDEB9").s().p("AgyLFQifgLiXgrQg6gRg0gZQkUiEgYlXIAAgBQgWk8C/juQArg2A0gvQA2gvA9gkQCLhTCbgUQBOgLBMAGQDYANC9CNIAWARQA3AsAvA1QCPCqAiDSQAYCUgfCaQgfCXhUBrQiDCojwAfQhTALhVADIgwAAQg1AAgzgDg");
	this.shape_122.setTransform(-0.2,-72.1);

	this.shape_123 = new cjs.Shape();
	this.shape_123.graphics.f("#FEDEB9").s().p("AgnLrQiqgJiigmQg/gPg3gZQksh/gelwIAAgBQgalODGj/QAtg5A2g0QA5gyBAgnQCUhcChgYQBTgMBRAEQDlAKDLCSIAYASQA7AuA0A2QCbCzAoDcQAdCdgdClQgdCihWBxQiHCzkCAgQhYALhaADIhEABQgwAAgtgCg");
	this.shape_123.setTransform(-0.2,-75.9);

	this.shape_124 = new cjs.Shape();
	this.shape_124.graphics.f("#FEDEB9").s().p("AgdMQQizgGiugiQhEgNg7gXQlEh7gimIIAAgBQgfliDNkPQAug9A5g4QA8g1BDgrQCchjCpgcQBWgPBWAEQDzAHDZCWIAaATQA/AvA4A5QCnC8AvDmQAiCkgbCwQgbCvhYB3QiKC+kWAgQhdALhfADQgvABguAAIhNgBg");
	this.shape_124.setTransform(-0.2,-79.7);

	this.shape_125 = new cjs.Shape();
	this.shape_125.graphics.f("#FEDEB9").s().p("AgTM2Qi9gFi5gcQhJgMg/gWQlch1gnmhIAAgCQgjl0DUkgQAwhBA7g8QA/g5BGgtQCkhrCwggQBbgRBbADQEAADDnCcIAcATQBDAxA8A7QC0DEA2DxQAmCrgZC8QgaC6hZB+QiODJkpAgQhiAKhkAEQg8ADg8AAIg7gBg");
	this.shape_125.setTransform(-0.1,-83.5);

	this.shape_126 = new cjs.Shape();
	this.shape_126.graphics.f("#FEDEB9").s().p("AgJNbQjGgCjFgYQhOgKhDgUQlzhxgtm5IAAgCQgnmIDbkwQAxhFA/g/QBBg9BIgxQCthyC3gkQBggTBgACQEMgBD2ChIAdAUQBIAyBAA+QDADNA9D7QArCygYDIQgXDGhbCEQiSDUk7AgQhoAKhoAEQhMADhMAAIglAAg");
	this.shape_126.setTransform(-0.1,-87.3);

	this.shape_127 = new cjs.Shape();
	this.shape_127.graphics.f("#FEDEB9").s().p("AmgNuQocg0g6onQg1n4FglwQBDhABMg0QETi6EpADQEqgDETC6QBMA0BDBAQFgFwg1H4Qg6InocA0QjRATjQAAQjPAAjRgTg");
	this.shape_127.setTransform(0,-91.1);

	this.shape_128 = new cjs.Shape();
	this.shape_128.graphics.f("#FEDEB9").s().p("AmGMtQkNgUinh+QhPg+gyhnQgghDgPhPQgEgbgCgdQgFg+ABg8QAIl+EGklIAogqQBBg9BKgyQEFixEmABIApAAQEPAHD0CeQBLAxBCA8QA1A0AtA4QDzEvgTGLIgBAYQgDAxgIAvIgIAtQgVBRgpBAQhABohmA1IgNAHIgEACQiLBFjAAOQjKAOjJAAQjIAAjKgOg");
	this.shape_128.setTransform(-0.1,-83.7);

	this.shape_129 = new cjs.Shape();
	this.shape_129.graphics.f("#FEDEB9").s().p("AltLtQj7gOi3hUQhXgrg5hdQgng+gPhLQgDgagCgbQgDg9ACg6QARlwEDkWQASgVAUgTQBAg7BGgwQD5inEhgDIAoAAQEMAFDpCPQBJAtBCA6QAzAvAuA1QD2EfgBF6IAAAXQgBAugFAuIgGAtQgTBMguA+QhFBfhpAkIgNAEIgEABQiQAuizAKQjDAJjDAAQjCAAjDgJg");
	this.shape_129.setTransform(-0.2,-76.3);

	this.shape_130 = new cjs.Shape();
	this.shape_130.graphics.f("#FEDEB9").s().p("AlUKsQjqgGjIgqQhdgZhBhTQgug5gRhHQgCgYAAgaQgCg7AEg4QAaljD+kIIAmglQA+g6BEgsQDrieEdgHIAnAAQEHACDeCCQBIAqBBA1QAzAsAvAyQD6EOAQFoIABAWQABAsgDAuIgDArQgTBJgxA6QhKBXhtASIgOACIgDABQiVAXimAEQi9AFi8AAQi6AAi8gFg");
	this.shape_130.setTransform(-0.1,-68.9);

	this.shape_131 = new cjs.Shape();
	this.shape_131.graphics.f("#FEDEB9").s().p("ALNJsIgDgBI23AAQhlgFhIhJQg1g0gShDIgBgvQABg5AFg3QAjlUD6j7QEkkjGbAAQGcAAEjEjQD9D9AhFWQAGA1gBA3IAAAqQgRBGg2A2QhQBPhvAAIgPAAg");
	this.shape_131.setTransform(0,-61.5);

	this.shape_132 = new cjs.Shape();
	this.shape_132.graphics.f("#FEDEB9").s().p("AlKKQQjigEjPgXQhhgRhEhOQgxg4gRhFIgCgwIAAgBQgBg6AFg3QAdlcD+kDIAlgkQA9g4BCgtQDmiZEbgIIAnAAQEFABDaB7QBHAoBBA1QAzAqAvAxQD7EGAXFhIACAWQABArgBAsIgCArQgSBIg0A4QhMBUhuAKIgOACIgDAAQiXANihACQi5ADi6AAQi3AAi5gDg");
	this.shape_132.setTransform(-0.1,-65.7);

	this.shape_133 = new cjs.Shape();
	this.shape_133.graphics.f("#FEDEB9").s().p("AlYK2QjsgIjFgwQhdgbhAhVQgtg5gQhIIgDgyIAAgBQgCg7AEg4QAYlkD/kLQATgTATgSQA+g6BEgtQDuifEdgGIAogBQEHADDgCDQBIAqBBA3QAzAsAvAzQD5EQAOFrIAAAWQABAtgDAsIgDAsQgTBKgxA6QhJBYhsAVIgOACIgEABQiUAaioAGQi9AFi9AAQi8AAi9gFg");
	this.shape_133.setTransform(-0.1,-70);

	this.shape_134 = new cjs.Shape();
	this.shape_134.graphics.f("#FEDEB9").s().p("AlmLaQj2gMi8hHQhYgmg8haQgpg9gQhKIgEgzIAAgBQgCg8ADg6QATlsEBkSQATgUAUgTQA/g7BFgvQD1ikEggEIAoAAQEKAEDmCLQBJAsBCA5QAzAuAuA0QD3EaAEF1IAAAXQAAAugEAtIgFAsQgUBMguA8QhHBdhqAfIgOAEIgDABQiSAnivAIQjBAIjBAAQjAAAjBgIg");
	this.shape_134.setTransform(-0.2,-74.2);

	this.shape_135 = new cjs.Shape();
	this.shape_135.graphics.f("#FEDEB9").s().p("Al0L/QkAgPiyhgQhVgxg3hgQglg/gPhMIgFg0IAAgCQgEg9ACg6QAOl1EEkaIAmgoQBBg9BHgwQD8ipEjgDIAoAAQENAGDsCUQBJAuBCA6QA0AxAuA2QD1EjgGF/IAAAXQgCAvgGAuIgGAtQgUBOgsA+QhEBihoApIgNAFIgEABQiPA0i3ALQjFALjEAAQjEAAjFgLg");
	this.shape_135.setTransform(-0.2,-78.4);

	this.shape_136 = new cjs.Shape();
	this.shape_136.graphics.f("#FEDEB9").s().p("AmCMkQkKgUiqh3QhQg8gzhlQghhCgPhPIgGg1IAAgDQgFg9ACg8QAIl8EHkjIAngpQBBg+BJgxQEEivElgBQAUAAAVABQEPAGDyCdQBKAwBDA8QA0AzAtA3QD0EtgQGJIgBAYQgEAwgGAvIgIAtQgVBQgqBAQhBBnhmAzIgNAGIgEACQiMBBi+AOQjJAOjIAAQjHAAjJgOg");
	this.shape_136.setTransform(-0.1,-82.6);

	this.shape_137 = new cjs.Shape();
	this.shape_137.graphics.f("#FEDEB9").s().p("AmRNJQkUgXigiQQhNhGgthsQgehEgOhRIgHg2IAAgEQgGg+AAg9QAEmEEIkqIAogrQBDg/BKgzQELi0EoABIAqAAQERAJD4CkQBLAyBDA+QA1A1AsA5QDyE3gaGTIgCAYQgEAygIAvQgEAXgGAXQgVBSgnBCQg+BrhkA9IgNAIIgEACQiKBOjFARQjNAQjMAAQjLAAjNgQg");
	this.shape_137.setTransform(-0.1,-86.9);

	this.shape_138 = new cjs.Shape();
	this.shape_138.graphics.f("#FEDEB9").s().p("AmUNVQoNgyg4oYQg0npFWlmQBCg+BJgzQELi1EhAEQEigEELC1QBJAzBCA+QFWFmgzHpQg5IYoNAyQjLATjKAAQjJAAjLgTg");
	this.shape_138.setTransform(0,-88.6);

	this.shape_139 = new cjs.Shape();
	this.shape_139.graphics.f("#FEDEB9").s().p("AmIM8Qn+gxg3oIQgynbFMlbQBAg9BHgxQEDivEZADQEagDEDCvQBHAxBAA9QFMFbgyHbQg3IIn9AxQjGASjEAAQjDAAjFgSg");
	this.shape_139.setTransform(0,-86);

	this.shape_140 = new cjs.Shape();
	this.shape_140.graphics.f("#FEDEB9").s().p("Al9MjQnugvg1n4QgxnNFClRQA+g7BFgwQD8iqEQADQERgDD8CqQBFAwA+A7QFCFRgxHNQg1H4nuAvQjAASi+AAQi9AAjAgSg");
	this.shape_140.setTransform(0,-83.5);

	this.shape_141 = new cjs.Shape();
	this.shape_141.graphics.f("#FEDEB9").s().p("AlxMLQnfgugznpQgwm/E4lGQA8g5BDguQD0ilEIADQEJgDDzClQBDAuA9A5QE3FGguG/Qg0HpnfAuQi5ARi5AAQi3AAi6gRg");
	this.shape_141.setTransform(0,-81);

	this.shape_142 = new cjs.Shape();
	this.shape_142.graphics.f("#F1C27D").s().p("AlxMLQnfgugznpQgwm/E4lGQA8g5BDguQD0ilEIADQEJgDDzClQBDAuA9A5QE3FGguG/Qg0HpnfAuQi5ARi5AAQi3AAi6gRg");
	this.shape_142.setTransform(0,-81);

	this.shape_143 = new cjs.Shape();
	this.shape_143.graphics.f("#C68642").s().p("AlxMLQnfgugznpQgwm/E4lGQA8g5BDguQD0ilEIADQEJgDDzClQBDAuA9A5QE3FGguG/Qg0HpnfAuQi5ARi5AAQi3AAi6gRg");
	this.shape_143.setTransform(0,-81);

	this.shape_144 = new cjs.Shape();
	this.shape_144.graphics.f("#8D5524").s().p("AlxMLQnfgugznpQgwm/E4lGQA8g5BDguQD0ilEIADQEJgDDzClQBDAuA9A5QE3FGguG/Qg0HpnfAuQi5ARi5AAQi3AAi6gRg");
	this.shape_144.setTransform(0,-81);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_117}]}).to({state:[{t:this.shape_118}]},1).to({state:[{t:this.shape_119}]},1).to({state:[{t:this.shape_120}]},1).to({state:[{t:this.shape_121}]},1).to({state:[{t:this.shape_122}]},1).to({state:[{t:this.shape_123}]},1).to({state:[{t:this.shape_124}]},1).to({state:[{t:this.shape_125}]},1).to({state:[{t:this.shape_126}]},1).to({state:[{t:this.shape_127}]},1).to({state:[{t:this.shape_128}]},1).to({state:[{t:this.shape_129}]},1).to({state:[{t:this.shape_130}]},1).to({state:[{t:this.shape_131}]},1).to({state:[{t:this.shape_131}]},55).to({state:[{t:this.shape_132}]},1).to({state:[{t:this.shape_133}]},1).to({state:[{t:this.shape_134}]},1).to({state:[{t:this.shape_135}]},1).to({state:[{t:this.shape_136}]},1).to({state:[{t:this.shape_137}]},1).to({state:[{t:this.shape_127}]},1).to({state:[{t:this.shape_138}]},1).to({state:[{t:this.shape_139}]},1).to({state:[{t:this.shape_140}]},1).to({state:[{t:this.shape_141}]},1).to({state:[{t:this.shape_142}]},59).to({state:[{t:this.shape_143}]},3).to({state:[{t:this.shape_144}]},3).to({state:[{t:this.shape_144}]},16).to({state:[{t:this.shape_144}]},8).to({state:[]},36).wait(90));
...
// stage content:
(lib.character_button_create = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(159.5,237.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(41).to({startPosition:41},0).to({y:297.3,startPosition:66},25).wait(217));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(251.2,364.8,137.8,296.5);
// library properties:
lib.properties = {
	width: 320,
	height: 468,
