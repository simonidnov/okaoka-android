...
// stage content:
(lib.popup_motion_character = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(40).to({startPosition:40},0).wait(1).to({startPosition:40},0).to({regY:0,scaleX:0.62,scaleY:0.62,x:207.7,y:114.7,startPosition:66},25).wait(217));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(367.9,125.2,79,170);
// library properties:
lib.properties = {
	width: 400,
	height: 200,
