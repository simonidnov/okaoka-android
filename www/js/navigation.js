var navigation = {
    ...
    check_activity : function(){
        if(navigation._current_page_name !== "screensaver" && navigation._current_page_name !== "video" && navigation._current_page_name !== "switcher" && navigation._current_page_name !== "settings"  && navigation._current_page_name !== "basketball" && navigation._current_page_name !== "drop_circle" && navigation._current_page_name !== "code2" && navigation._current_page_name !== "number" && navigation._current_page_name !== "character_frame"){
    ...
    create_routes : function(){
        var Router = Backbone.Router.extend({
            ...
            changepage : function(name, intro){
                ...
                if(name == "menu" && navigation.last_page != "menu" && typeof navigation.last_page != "undefined"){
                  window.location.reload();
                }
                navigation.last_page = name;
    ...
    init_current_page : function(callBack){
        if(typeof this.page_properties.motion !== "undefined" && navigation.intro){
            ...
            //setTimeout(function(){
                ...
                if(typeof lib[self.page_properties.motion] !== "undefined"){
            ...
            /* UNCOMENT TO PLAY AMBIANCE SOUNDS FOR EACH GAMES ID EXIST
            setTimeout(function(){
