...
(lib.basketball_game_motion = function(mode,startPosition,loop) {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FFFFFF").ss(6).p("AGEk1IhmDJIg4C+IAACxIAABBAgDhsIAAjJAgDBSIAAi+IkaAAIA4C+IDiAAIDpAAAmDk1IBmDJAgDFBIAAg+IDpAAAjlEDIAABBAjlEDIDiAAIAAixAjlBSIAACxAEehsIkhAA");
	this.shape_2.setTransform(471.2,34.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#FFFFFF").ss(6).p("AEehsIg4C+IAACxIAABBAGEk1IhmDJIkhAAIkaAAIA4C+IAACxIDiAAIAAixIDpAAAjlBSIDiAAIAAi+IAAjJAmDk1IBmDJAjlEDIAABBAgDFBIAAg+IDpAA");
