...
(lib.poignee = function(mode,startPosition,loop) {
...
(lib.original_okaoka = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Calque 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(9,1).p("ABUgnIinAAQgnAAgdgcQgcgcAAgoIAAj0QAAgnAcgdQAdgcAnAAICnAAQAoAAAcAcQAcAdAAAnIAAD0QAAAogcAcQgcAcgoAAgAizHcIDGklIChElAizB3IFnAA");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-22.6,-52.2,45.2,104.4);
...
(lib.exit_button = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(66).call(this.frame_66).wait(2));

	// Calque 5
	this.instance = new lib.poignee();
	this.instance.setTransform(-109.7,-23.8,1.953,1.953,0,0,0,0,-3.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({_off:false},0).wait(29).to({x:-88.2,y:-2.8},7).wait(15).to({x:-109.7,y:-23.8},5).wait(6));

	// cadre
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(5,1,1).p("AHZJ2IuxAAIAAzrIOxAAg");
	this.shape.setTransform(-79,-29.8);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(6).to({_off:false},0).to({_off:true},29).wait(33));

	// Calque 8
	this.instance_1 = new lib.original_okaoka();
	this.instance_1.setTransform(-154.8,-18.5,1,1,-15,0,0,-0.1,-0.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(40).to({_off:false},0).to({scaleX:1,scaleY:1,rotation:-14.8,x:-150.4},1).wait(1).to({x:-146.1},0).wait(1).to({x:-141.8},0).wait(1).to({x:-137.4},0).to({_off:true},1).wait(23));

	// Calque 7
	this.instance_2 = new lib.walking_09("synched",14);
	this.instance_2.setTransform(-366.2,-78.2,0.553,0.553,0,0,0,-76.6,-111.2);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).to({x:-220.2,startPosition:15},29).to({x:-214.3,startPosition:16},1).to({x:-208.5,startPosition:17},1).to({x:-202.7,startPosition:18},1).to({x:-196.8,startPosition:20},1).to({_off:true},1).wait(28));

	// cadre
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FFFFFF").ss(5,1,1).p("AHZJ2IuxAAIAAzrIOxAAg");
	this.shape_1.setTransform(-79,-29.8);
	this.shape_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(6).to({_off:false},0).to({_off:true},29).wait(33));

	// Calque 3
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FFFFFF").ss(5,1,1).p("EgimAAAMBFNAAA");
	this.shape_2.setTransform(-70.4,33.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#FFFFFF").ss(5,1,1).p("AGDJ1IuxAAIAAzqIOxAAgEgimAJ2MBFNAAA");
	this.shape_3.setTransform(-70.4,-29.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#FFFFFF").ss(5,1,1).p("AGDqDIABAAIAATrIgQAAIt/AdIAAgdIAAgBIgjAAIAAzrIOxAAgAoLJnIAAzNIOOgdEgimAJoIabAAAF0JoIczAA");
	this.shape_4.setTransform(-70.4,-28.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#FFFFFF").ss(5,1,1).p("AGDqRIABAAIAATqItsA7IAAg7IAAgBIhGAAIAAzrIOxAAgAnoJYIAAyvINrg6EgimAJZIa+AAAGEJZIcjAA");
	this.shape_5.setTransform(-70.4,-26.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#FFFFFF").ss(5,1,1).p("AGDqfIACAAIAATpIAAABItKBYIAAhZIAAgBIhpAAIAAzrIOxAAgAnFJJIAAyRINIhXEgimAJKIbhAAAGFJKIciAA");
	this.shape_6.setTransform(-70.4,-25.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#FFFFFF").ss(5,1,1).p("AGDqtIADgBIAATpIAAACIsoB1IAAh3IAAgBIiMAAIAAzrIOxAAgAmiI6IAAxzIMlh0EgimAI7IcEAAAGGI7IchAA");
	this.shape_7.setTransform(-70.4,-23.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#FFFFFF").ss(5,1,1).p("AGDq7IAEgBIAAToIAAADIsGCSIAAiVIAAgBIivAAIAAzrIOxAAgAl/IrIAAxVIMCiREgimAIsIcnAAAGHIsIcgAA");
	this.shape_8.setTransform(-70.4,-22.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#FFFFFF").ss(5,1,1).p("AGDrJIAFgBIAATnIAAADIrjCwIAAizIAAgBIjTAAIAAzrIOxAAgAlbIcIAAw3ILeiuEgimAIdIdLAAAGIIdIcfAA");
	this.shape_9.setTransform(-70.4,-20.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#FFFFFF").ss(5,1,1).p("Ak4INIj2AAIAAzrIOxAAIAAAIIAGgCIAATmIAAAEIrBDNIAAjRIAAgBIAAwZIK7jKEgimAIOIduAAAGJIOIceAA");
	this.shape_10.setTransform(-70.4,-19.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#FFFFFF").ss(9,1).p("AA8hGIgEABIidAqQgmAKgjgTQgjgUgKgnIg+jrQgKgmAUgjQAUgjAngKICigrQAogKAgAUQAWANAMAUQAHAMADAOIA/DrQAKAmgUAjQgUAignAKgAg+HwIB0lPIACACIDlDwAiZCWIDRg4ICKgk");
	this.shape_11.setTransform(-132,-17.5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#FFFFFF").ss(5,1,1).p("AoumuIAAkwIOxAAIAAAIIAGgCIAATmIAAAEIrBDNIAAjRIAAgBIj2AAIAAlYIAAhEIAAikAk4INIAAwZIK7jKEgimAIOIduAAAGJIOIceAA");
	this.shape_12.setTransform(-70.4,-19.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#FFFFFF").ss(9).p("AhlhpIDLDT");
	this.shape_13.setTransform(-111.9,9.3);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#FFFFFF").ss(9,1).p("ABqhGIgvAMIhyAgQgmAKgjgUQgjgUgKgmIg/jrQgKgnAUgiQAUgjAngKICigsQAhgKAfAQQAEABAEADQAiAUALAmIA/DrQAKAngUAiQgUAignALgAhrCXICmgtIC2gxAgOHwIBJjXIAqh4");
	this.shape_14.setTransform(-132.3,-17.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#FFFFFF").ss(5,1,1).p("AounTIAAkLIOxAAIAAAIIAGgCIAATmIAAAEIrBDNIAAjRIAAgBIj2AAIAAjiIAAivIAAikAk4INIAAiFIAAuUIK7jKEgimAIOIduAAAGJIOIceAA");
	this.shape_15.setTransform(-70.4,-19.3);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#FFFFFF").ss(9).p("AAAAAIABAB");
	this.shape_16.setTransform(-122.5,-1.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#FFFFFF").ss(9,1).p("ABWhGIgvAMIhyAgQgmAKgjgUQgjgUgKgmIg/jrQgKgnAUgiQAUgjAngKICigsQAhgKAfAQQAEABAEADQAiAUALAmIA/DrQAKAngUAiQgUAignALgABMCwIAEgLIABgEABBClIAGAHIAFAFIAAgBAh/CXICmgtIC2gxAgiHwIBJjXIAlhoIC4DAABHCsIAFAE");
	this.shape_17.setTransform(-130.3,-17.5);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#FFFFFF").ss(5,1,1).p("AounTIAAkLIOxAAIAAAIIAGgCIAATmIAAAEIrBDNIAAjRIAAgBIj2AAIAAjiIAAivIAAikAk4INIAAwZIK7jKEgimAIOIduAAAGJIOIceAA");
	this.shape_18.setTransform(-70.4,-19.3);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#FFFFFF").ss(9).p("AiDgqID0g0AgDgUIBvCB");
	this.shape_19.setTransform(-113.1,-0.3);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("#FFFFFF").ss(9,1).p("AB/hAIiVAfIgOADQgnAIgigVQghgWgJgnIgxjuQgIgnAWghQAWgiAmgIIBogWIA7gNQAogIAhAWQAiAWAIAnIAxDuQAJAngWAhQgWAignAIgAhiCRIBMgQAgZHuIADgGICDlC");
	this.shape_20.setTransform(-124,-17.6);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#FFFFFF").ss(5,1,1).p("AounNIAAkRIOxAAIAAAIAk4INIj2AAIAAgUIAAlnIAAiiAk4INIAAmvIAApqIK7jKIAGgCIAATmIAAAEIrBDNIAAjRgEgimAIOIduAAAGJIOIceAA");
	this.shape_21.setTransform(-70.4,-19.3);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("#FFFFFF").ss(9).p("AAkk4QAggFAbAOABfB2IicAZAiEE7IDjgj");
	this.shape_22.setTransform(-111.3,-35.6);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#FFFFFF").ss(9,1).p("AALghQglAGghgXQgJgHgHgHQgSgVgFgcIgljxQgGgnAYggQARgYAZgJQAKgEALgCICkgaAgOHrICXlB");
	this.shape_23.setTransform(-118.7,-17.8);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f().s("#FFFFFF").ss(5,1,1).p("Ak4INIAAmYIAAigIAAmmIAAg7IK7jKAoum8IAAkiIOxAAIAAAIIAGgCIAATmIAAAEIrBDNIAAjRIAAgBIj2AAIAAo/EgimAIOIduAAAGJIOIceAA");
	this.shape_24.setTransform(-70.4,-19.3);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("#FFFFFF").ss(9).p("AAYjVIA1gFABEDaQgnAEgdgYQgfgZgEgo");
	this.shape_25.setTransform(-114.4,-43.6);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f().s("#FFFFFF").ss(9,1).p("AghiBIgYjzQgEgnAZgfQAZggAmgEAggB7IBWgJAAHHfIA0hg");
	this.shape_26.setTransform(-114.6,-17.1);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f().s("#FFFFFF").ss(5,1,1).p("AlpIiIAAvaIAAhpILsiiIAFgBIAATnIAAADIrxCkIAAinIAAgBIjFAAIAAzrIOxAAIAAAGEgimAIjIc9AAAGIIjIcfAA");
	this.shape_27.setTransform(-70.4,-21.4);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f().s("#FFFFFF").ss(5,1,1).p("AGDqwIADAAIAAToIAAACIshB7IAAh9IAAgBIiTAAIAAzrIOxAAgAmbI3IAAxtIMeh6EgimAI4IcLAAAGGI4IchAA");
	this.shape_28.setTransform(-70.4,-23.5);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f().s("#FFFFFF").ss(5,1,1).p("AGDqcIACgBIAATqIAAABItRBSIAAhTIAAgBIhiAAIAAzrIOxAAgAnMJMIAAyXINPhREgimAJNIbaAAAGFJNIciAA");
	this.shape_29.setTransform(-70.4,-25.6);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f().s("#FFFFFF").ss(5,1,1).p("AGDqJIABAAIAATrIgLAAIt2ApIAAgpIAAgBIgxAAIAAzrIOxAAgAn9JhIAAzAIOAgqEgimAJiIapAAAF5JiIcuAA");
	this.shape_30.setTransform(-70.4,-27.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2}]},6).to({state:[{t:this.shape_3}]},29).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_12},{t:this.shape_11}]},1).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13}]},1).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16}]},1).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13}]},8).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19}]},1).to({state:[{t:this.shape_24},{t:this.shape_23},{t:this.shape_22}]},1).to({state:[{t:this.shape_27},{t:this.shape_26},{t:this.shape_25}]},1).to({state:[{t:this.shape_28}]},1).to({state:[{t:this.shape_29}]},1).to({state:[{t:this.shape_30}]},1).to({state:[{t:this.shape_3}]},1).wait(6));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-366.1,-95.3,519.8,133.3);
...
(lib.exit_game_motion = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{choice_1:46,choice_0:65});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(45).call(this.frame_45).wait(19).call(this.frame_64).wait(2).call(this.frame_66).wait(1));

	// Calque 4
	this.instance = new lib.exit_button("synched",6,false);
	this.instance.setTransform(289,104,1,1,0,0,0,9,-37.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(65).to({startPosition:52},0).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(138.9,145.9,494.7,133.3);
